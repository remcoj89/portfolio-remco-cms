import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-JMZ37VDP.js";
import "./chunk-RTLWFS6O.js";
import {
  Box,
  Button2 as Button,
  Card,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-HUHB5YJL.js")),
  document: (0, import_react.lazy)(() => import("./pane-IPDBNIC7.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-IPDBNIC7.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-4N5GK75M.js"))
};
...
//# sourceMappingURL=index3-HZBXGFPF.js.map
