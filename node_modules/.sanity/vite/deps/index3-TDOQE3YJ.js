import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-3TVJ2V4R.js";
import "./chunk-VUSEENLK.js";
import {
  Box,
  Button2 as Button,
  Card,
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-CYETK37B.js")),
  document: (0, import_react.lazy)(() => import("./pane-UMUUKIZB.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-UMUUKIZB.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-XBMV43NS.js"))
};
...
//# sourceMappingURL=index3-TDOQE3YJ.js.map
